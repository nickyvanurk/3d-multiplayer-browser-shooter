...
export class NetworkServer {
  ...
  addConnection(connection) {
    ...
    for (const entity of this.world.entities.values()) {
      ...
      connection.pushMessage(new Messages.Spawn(entity.id, entity.type, position, rotation, scale));
    }
  ...
  onEntitySpawned(entity) {
    ...
    this.broadcastMessage(new Messages.Spawn(entity.id, entity.type, position, rotation, scale));
  }
  ...
  broadcast(world, _time) {
    ...
    for (const id of this.lastAlive.keys()) {
      if (!world.entities.has(id)) {this.lastAlive.delete(id);}
    }
  ...
  broadcastMessage(message, ignoredId = null) {
    for (const connection of this.connections) {
